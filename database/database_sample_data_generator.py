...
class DatabaseDataGenerator:
    ...
    def generate_users(self, number_of_users: int) -> None:
        ...
        """
        [self.query.add_new_user_to_database(
    ...
    def generate_read_books(self, number_of_read_books: int) -> None:
        ...
        """
        [self.query.add_read_book_to_user_list(
            self.query.get_random_username(),
            self.query.get_random_book_title()
        ) for _ in range(number_of_read_books)]
    ...
    def generate_reviews(self, number_of_reviews: int) -> None:
        ...
        for _ in range(number_of_reviews):
            ...
            self.query.add_review_to_user_book(
                username=username,
